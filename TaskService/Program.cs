...
builder.Services.AddDbContext<TaskDbContext>(options => options.UseNpgsql(connString));
...
builder.Services.AddScoped<ITaskStatisticRepository, TaskStatisticRepository>();
